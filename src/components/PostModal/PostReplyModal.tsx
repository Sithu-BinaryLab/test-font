...
const styles = {
  ...
  replyModal: (open: boolean) => {
    const state = open ? "top-20 border-t broder-t-newsmast-blue-grey h-screen" : "reverse-shadow"
...
const PostReplyModal: React.FC<PostReplyModalProps> = () => {
  ...
  return (
    ...
    <div className="z-50">
      <div className={styles.publishButton(open)} onClick={goToCreatePost}>
        Publish
      </div>
      <div className={styles.replyModal(open)} style={{ minHeight: "5rem" }}>
        ...
        <div className="relative" style={{ height: "100%" }}>
          <div className={styles.inputIcons(open)}>
            ...
            <div className="text-newsmast-grey" onClick={goToCreatePost}>
              Publish
            </div>
          </div>
        </div>
